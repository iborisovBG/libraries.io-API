<div class="container">
	<div class="row">
		<div class="col-lg-8 col-lg-offset-2">
			<h2>Настройки</h2>
			<h5>Здравей, <span><?php echo $first_name; ?></span>.</h5>
			<hr>
			<?php
        ...
        ?>
			...
			<div class="form-group">
				...
				<?php echo form_input(array('name'=>'site_title', 'id'=> 'site_title', 'placeholder'=>'Име на сайта', 'class'=>'form-control', 'value' => set_value('site_title', $site_title))); ?>
				<?php echo form_error('site_title');?>
			</div>

			<div class="form-group">
				<span>Времева зона</span>
			...
			<?php echo form_submit(array('value'=>'Запази', 'name'=>'submit', 'class'=>'btn btn-primary btn-block')); ?>
			<?php echo form_close(); ?>
		</div>
	</div>
</div>
