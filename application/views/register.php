<div class="col-lg-4 col-lg-offset-4">
	...
	<div class="form-group">
		<?php echo form_input(array('name'=>'email', 'id'=> 'email', 'placeholder'=>'Е-майл', 'class'=>'form-control', 'value'=> set_value('email'))); ?>
    ...
    echo form_submit(array('value'=>'Регистрация', 'class'=>'btn btn-lg btn-primary btn-block')); ?>
	<?php echo form_close(); ?>
	<br>
	<p>Регистрирани сте? <a href="<?php echo site_url();?>main/login">Вход</a></p>
</div>
